...
/// hicolor (`com.enikeev.cosmic_bwarden-symbolic.svg`).
pub const APP_ICON: &str = "com.enikeev.cosmic_bwarden-symbolic";
...
pub fn on_unlock_event(app: &mut CosmicBWardenApp, pin: bool) -> Task<Message> {
