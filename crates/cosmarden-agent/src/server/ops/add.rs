...
pub async fn add_entry_on_server(
    ...
    entry: &cosmarden_core::db::Entry,
    config: &cosmarden_core::config::CosmardenConfig,
    keys: &cosmarden_core::locked::Keys,
) -> Result<(), String> {
    let name_enc = match cosmarden_core::cipherstring::CipherString::encrypt_symmetric(
        keys,
        entry.name.as_bytes(),
    ) {
        Ok(cs) => cs.to_string(),
    ...
    if let Some(n) = &entry.notes {
        notes_enc = Some(
            match cosmarden_core::cipherstring::CipherString::encrypt_symmetric(
                keys,
                n.expose().as_bytes(),
            ) {
                Ok(cs) => cs.to_string(),
    ...
    let (
        ...
        cosmarden_core::db::EntryData::Login {
            username,
            password,
            totp,
            uris,
            ...
            (1, u_enc, p_enc, None, None, None, None, None, None, None)
        }
        cosmarden_core::db::EntryData::SecureNote => {
            (2, None, None, None, None, None, None, None, None, None)
        }
        cosmarden_core::db::EntryData::Identity {
            first_name,
            last_name,
            address1,
            city,
            ...
            let mut id = cosmarden_core::api::CipherIdentity {
                first_name: None,
                last_name: None,
                address1: None,
                city: None,
            ...
            let encrypt = |s: &Option<String>| -> Result<Option<String>, String> {
                if let Some(s) = s {
                    Ok(Some(
                        cosmarden_core::cipherstring::CipherString::encrypt_symmetric(
                            keys,
                            s.as_bytes(),
                        )
            ...
            (4, None, None, None, None, None, Some(id), None, None, None)
        }
        cosmarden_core::db::EntryData::Card {
            cardholder_name,
            brand,
            number,
            exp_month,
            ...
            let mut card = cosmarden_core::api::CipherCard {
        ...
        cosmarden_core::db::EntryData::SshKey {
            private_key,
            public_key,
            ..
        } => {
            ...
            (
                5, None, None, priv_enc, pub_enc, None, None, None, None, None,
            )
        }
        cosmarden_core::db::EntryData::BankAccount {
            bank_name,
            name_on_account,
            account_type,
            account_number,
            ...
            let bank = cosmarden_core::api::CipherBankAccount {
        ...
        cosmarden_core::db::EntryData::DriversLicense {
            ...
            let dl = cosmarden_core::api::CipherDriversLicense {
            ...
            (7, None, None, None, None, None, None, None, Some(dl), None)
        }
        cosmarden_core::db::EntryData::Passport {
            surname,
            given_name,
            date_of_birth,
            sex,
            ...
            let pp = cosmarden_core::api::CipherPassport {
            ...
            (8, None, None, None, None, None, None, None, None, Some(pp))
        }
    };
    ...
    for field in &entry.fields {
        ...
        fields_enc.push(cosmarden_core::api::CipherField {
            ty: field.ty,
            name: name_enc,
            value: value_enc,
    ...
    with_refresh(state, |at| {
        ...
        async move {
            let client = cosmarden_core::api::Client::new(&base_url, &identity_url);
            match ty {
                1 | 2 => {
                    client
                        .add_cipher(
                ...
                8 => {
                    let pp = passport_payload.unwrap();
                    client
                        .add_new_type_cipher(
                            &at,
                            8,
