...
use cosmarden_core::db::{Entry, Field, Secret, Uri};
use cosmarden_core::protocol::{EntryType, Response};
use std::sync::Arc;
...
pub async fn handle_add_entry(
    ...
    let entry = Entry {
        ...
        history: Vec::new(),
        key: None,
        master_password_reprompt: cosmarden_core::api::CipherRepromptType::None,
    };
...
pub async fn handle_add_ssh_key(
    ...
    fields.push(Field {
        ...
        ty: Some(cosmarden_core::api::FieldType::Hidden),
        linked_id: None,
    });
    if let Some(pubk) = &public_key {
        fields.push(Field {
            ...
            ty: Some(cosmarden_core::api::FieldType::Text),
            linked_id: None,
        });
    }
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::SshKey {
...
pub async fn handle_add_card(
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::Card {
            cardholder_name,
            brand,
            number,
            exp_month,
...
pub async fn handle_add_identity(
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::Identity {
            title: None,
            first_name,
            middle_name: None,
            last_name,
...
pub async fn handle_add_bank_account(
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::BankAccount {
            bank_name,
            name_on_account,
            account_type,
            account_number,
...
pub async fn handle_add_drivers_license(
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::DriversLicense {
            first_name,
            middle_name,
            last_name,
            date_of_birth,
...
pub async fn handle_add_passport(
    ...
    let entry = Entry {
        ...
        name,
        favorite: false,
        data: cosmarden_core::db::EntryData::Passport {
            surname,
            given_name,
            date_of_birth,
            sex,
...
async fn add_entry_to_server(entry: Entry, state: &Arc<Mutex<State>>) -> Response {
    let entry_type = match &entry.data {
        cosmarden_core::db::EntryData::Login { .. } => "login",
        cosmarden_core::db::EntryData::SecureNote => "secure_note",
        cosmarden_core::db::EntryData::SshKey { .. } => "ssh_key",
        cosmarden_core::db::EntryData::Card { .. } => "card",
        cosmarden_core::db::EntryData::Identity { .. } => "identity",
        cosmarden_core::db::EntryData::BankAccount { .. } => "bank_account",
        cosmarden_core::db::EntryData::DriversLicense { .. } => "drivers_license",
        cosmarden_core::db::EntryData::Passport { .. } => "passport",
    };
