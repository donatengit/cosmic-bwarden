...
pub enum EntryType {
    ...
    SecureNote,
    SshKey,
    /// Bitwarden v2026.7.0 cipher types 6-8 (read-only support; see
    /// CONTEXT.md "New cipher types").
    BankAccount,
    DriversLicense,
    Passport,
}
...
pub enum Action {
    ...
    AddBankAccount {
        ...
        account_number: Option<crate::db::Secret>,
        routing_number: Option<crate::db::Secret>,
        branch_number: Option<String>,
        pin: Option<crate::db::Secret>,
    ...
    AddDriversLicense {
        ...
        license_number: Option<crate::db::Secret>,
    ...
    AddPassport {
        ...
        issuing_country: Option<String>,
        passport_number: Option<crate::db::Secret>,
...
impl Action {
    ...
    pub fn variant_name(&self) -> &'static str {
        match self {
            ...
            Self::AddBankAccount { .. } => "AddBankAccount",
            Self::AddDriversLicense { .. } => "AddDriversLicense",
            Self::AddPassport { .. } => "AddPassport",
...
pub enum Response {
    ...
    Config {
        config: crate::config::CosmardenConfig,
        needs_login: bool,
        has_account: bool,
        is_locked: bool,
