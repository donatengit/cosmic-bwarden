...
pub fn save_action(entry: Entry) -> AgentAction {
    ...
    match data {
        ...
        EntryData::BankAccount {
            ...
            iban,
            bank_contact_phone,
        } => AgentAction::AddBankAccount {
            name,
            bank_name: non_empty(bank_name),
            name_on_account: non_empty(name_on_account),
            account_type: non_empty(account_type),
            account_number: non_empty_secret(account_number),
            routing_number: non_empty_secret(routing_number),
            branch_number: non_empty(branch_number),
            pin: non_empty_secret(pin),
            swift_code: non_empty(swift_code),
            iban: non_empty(iban),
            bank_contact_phone: non_empty(bank_contact_phone),
            notes,
            fields,
        },
        EntryData::DriversLicense {
            ...
            issuing_authority,
            license_class,
        } => AgentAction::AddDriversLicense {
            name,
            first_name: non_empty(first_name),
            middle_name: non_empty(middle_name),
            last_name: non_empty(last_name),
            date_of_birth: non_empty(date_of_birth),
            license_number: non_empty_secret(license_number),
            issuing_country: non_empty(issuing_country),
            issuing_state: non_empty(issuing_state),
            issue_date: non_empty(issue_date),
            expiration_date: non_empty(expiration_date),
            issuing_authority: non_empty(issuing_authority),
            license_class: non_empty(license_class),
            notes,
            fields,
        },
        EntryData::Passport {
            ...
            issue_date,
            expiration_date,
        } => AgentAction::AddPassport {
            name,
            surname: non_empty(surname),
            given_name: non_empty(given_name),
            date_of_birth: non_empty(date_of_birth),
            sex: non_empty(sex),
            birth_place: non_empty(birth_place),
            nationality: non_empty(nationality),
            issuing_country: non_empty(issuing_country),
            passport_number: non_empty_secret(passport_number),
            passport_type: non_empty(passport_type),
            national_identification_number: non_empty(national_identification_number),
            issuing_authority: non_empty(issuing_authority),
            issue_date: non_empty(issue_date),
            expiration_date: non_empty(expiration_date),
            notes,
