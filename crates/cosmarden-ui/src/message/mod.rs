...
use cosmarden_core::protocol::{EntryType, GeneratorHistoryEntry, GeneratorSettings, SidebarEntry};
...
/// `CosmardenApp::unlock_mode`. The applet and main window share this so
...
pub type ConfigSnapshot = (CosmardenConfig, bool, bool, bool, bool, u64, u64);
...
pub enum Message {
    ...
    EventReceived(cosmarden_core::protocol::Event),
    TogglePin(String),
    ToggleSearchPinned,
    ...
    TpmDaStatusReceived(Option<cosmarden_core::protocol::TpmDaStatus>),
