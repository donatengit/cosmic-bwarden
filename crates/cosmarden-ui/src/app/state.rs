...
use cosmarden_core::db::{Entry, Secret};
...
pub const APP_ID: &str = "com.enikeev.cosmarden";
...
mod app_id_tests {
    ...
    fn app_id_is_a_valid_dbus_object_path_when_dot_replaced_with_slash() {
        assert_eq!(APP_ID, "com.enikeev.cosmarden");
        assert!(
            !APP_ID.contains("cosmic-bwarden") && !APP_ID.contains("COSMIC_BWARDEN"),
            "shipped App ID still uses the old product prefix: {APP_ID}"
        );
...
pub struct CosmardenApp {
    pub core: Core,
    pub config: CosmardenConfig,
    ...
    pub editing_config: Option<CosmardenConfig>,
    ...
    pub tpm_da: Option<cosmarden_core::protocol::TpmDaStatus>,
    ...
    pub generator_settings: cosmarden_core::protocol::GeneratorSettings,
    pub generator_result: Option<Secret>,
    pub generator_result_revealed: bool,
    pub generator_history: Vec<cosmarden_core::protocol::GeneratorHistoryEntry>,
...
impl Default for CosmardenApp {
    fn default() -> Self {
        Self {
            core: Core::default(),
            config: CosmardenConfig::default(),
            config_loaded: false,
            windows: HashMap::new(),
            view: View::Loading,
            auth_loading: false,
            ...
            totp_code: None,
            generator_settings: cosmarden_core::protocol::GeneratorSettings::default(),
