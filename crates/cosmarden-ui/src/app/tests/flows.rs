...
use cosmarden_core::protocol::entry_save::save_action;
use cosmarden_core::protocol::{Action as AgentAction, EntryType, SidebarEntry};
use cosmic::widget;
...
fn test_settings_flow() {
    ...
    // on the developer's own ~/.config/cosmarden/config.json — which is
