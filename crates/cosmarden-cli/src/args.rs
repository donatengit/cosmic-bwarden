...
use cosmarden_core::protocol::EntryType as ProtocolEntryType;
...
#[command(
    ...
    long_about = "Cosmarden: Bitwarden-compatible password manager for COSMIC DE",
    after_help = format!(
        "EXAMPLES:
  cosmarden note ls
  cosmarden get note \"My Note\"
  cosmarden login (lists all logins)
