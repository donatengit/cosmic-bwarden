...
use cosmarden_core::db::{EntryData, Field};
use cosmarden_core::protocol::{Action, EntryType, Response};
...
async fn test_login_with_uris() -> Result<()> {
    ...
    if let EntryData::Login { ref mut uris, .. } = entry.data {
        uris.push(cosmarden_core::db::Uri {
        ...
        .send(Action::AddEntry {
            ...
            fields: vec![
                ...
                Field {
                    ...
                    ty: Some(cosmarden_core::api::FieldType::Boolean),
                    linked_id: None,
                },
            ],
            totp: None,
