...
async fn server_accepts_new_item_types(
    ...
    use cosmarden_core::api::{Client as ApiClient, KdfType};
    use cosmarden_core::identity::Identity;
...
async fn test_all_eight_types_coexist() -> Result<()> {
    ...
    add!((
        Action::AddEntry {
            ...
            entry_type: cosmarden_core::protocol::EntryType::Login,
    ...
    let cases = [
        ("T1 Login", cosmarden_core::protocol::EntryType::Login),
        ("T3 Card", cosmarden_core::protocol::EntryType::Card),
        ("T4 Identity", cosmarden_core::protocol::EntryType::Identity),
        ("T2 Note", cosmarden_core::protocol::EntryType::SecureNote),
        ("T5 SSH", cosmarden_core::protocol::EntryType::SshKey),
        ("T6 Bank", cosmarden_core::protocol::EntryType::BankAccount),
        ("T7 DL", cosmarden_core::protocol::EntryType::DriversLicense),
        ("T8 Passport", cosmarden_core::protocol::EntryType::Passport),
    ];
